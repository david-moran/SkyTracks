...
namespace SpaceGraphicsToolkit
{
		...
		where T : Object
	{
		...
		protected bool Draw(string propertyPath, string overrideTooltip = null, string overrideDisplayName = null)
		{
			EditorGUI.BeginChangeCheck();
			{
				var property = serializedObject.FindProperty(propertyPath);
				...
				if (string.IsNullOrEmpty(overrideDisplayName) == false)
				{
					customContent.text = overrideDisplayName;
				}
		...
		protected void Draw(string propertyPath, ref bool modified, string overrideTooltip = null, string overrideDisplayName = null)
		{
			if (Draw(propertyPath, overrideTooltip, overrideDisplayName) == true)
			{
				modified = true;
			}
		}

		protected void Draw(string propertyPath, ref bool modified1, ref bool modified2, string overrideTooltip = null, string overrideDisplayName = null)
		{
			if (Draw(propertyPath, overrideTooltip, overrideDisplayName) == true)
			{
				modified1 = true;
